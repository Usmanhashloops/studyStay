      ...
      <div className="py-12 bg-white sm:py-16 lg:py-8">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col ">
                          ...
                          <tr className="bg-gray-50 border-b-[1px]" key={index}>
                            ...
                            <td className=" px-4 py-4 lg:table-cell whitespace-nowrap">
                              ...
                              >
                                ...
                                <button
                                  type="button"
                                  className="inline-flex items-center justify-center px-5 py-2 text-sm font-bold leading-5 text-white transition-all duration-200 bg-red-600 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 hover:bg-slate-500"
                                  onClick={() => {
            ...
            {allUsersData?.length > 0 ? <Pagination currentPage={currentPage} setCurrentPage={(page) => setCurrentPage(page)} pages={pages} /> : null}
          </div>
        </div>
      </div>
    </div>
