...
const SignUp = () => {
  ...
  return (
    <div>
      <section className="py-12 bg-gray-50 sm:pty-12 lg:py-12 h-screen centerScreen">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="relative max-w-md mx-auto lg:max-w-lg">
            <div className="relative overflow-hidden bg-white shadow-xl rounded-xl containerWidth">
                    ...
                    <div>
                      ...
                      <div className="mt-2.5 relative">
                        <input
                          ...
                          className="block w-full px-4 py-4 text-gray-900 placeholder-gray-600 bg-white border border-gray-400 rounded-xl focus:border-gray-900 focus:ring-gray-900 caret-gray-900"
                        />
                        <div className="absolute top-1/2 right-4 mt-0 transform -translate-y-1/2 cursor-pointer" onClick={handleToggleConfirmPasswordVisibility}>
                          {showConfirmPassword ? (
                            <AiFillEye style={{ height: "20px", width: "20px", color: "black" }} /> // Eye close icon
                          ) : (
                            <AiFillEyeInvisible style={{ height: "20px", width: "20px", color: "black" }} /> // Eye open icon
              ...
              {questionsModal && <QuestionsModal open={questionsModal} onClose={handleClose} name={name} email={email} password={password} confirmPassword={confirmPassword} />}
            </div>
          </div>
        </div>
      </section>
