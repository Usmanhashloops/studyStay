        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-0 max-w-7xl">
          ...
          {/* <div class="grid grid-cols-2 gap-4 mt-8 sm:mt-12 sm:gap-6 lg:grid-cols-4">
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                <p class="text-xs font-bold tracking-wide text-gray-400 uppercase">Kids Dress</p>
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$19.93</p>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                <p class="text-xs font-bold tracking-wide text-gray-400 uppercase">Winter collection</p>
                <h3 class="text-sm sm:text-base font-bold text-gray-900 flex-1 mt-2.5">
                  <a title="">
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$24.58</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                <p class="text-xs font-bold tracking-wide text-gray-400 uppercase">Men Dress</p>
                <h3 class="text-sm sm:text-base font-bold text-gray-900 flex-1 mt-2.5">
                  <a title="">
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$49.19</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                <p class="text-xs font-bold tracking-wide text-gray-400 uppercase">Shoe</p>
                <h3 class="text-sm sm:text-base font-bold text-gray-900 flex-1 mt-2.5">
                  <a title="">
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$16.00</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$23.88</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                <p class="text-xs font-bold tracking-wide text-gray-400 uppercase">Ladies dress</p>
                <h3 class="text-sm sm:text-base font-bold text-gray-900 flex-1 mt-2.5">
                  <a title="">
                    Kiddo Winter Boys Jacket
                    <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$34.99</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                <p class="text-xs font-bold tracking-wide text-gray-400 uppercase">Fashion</p>
                <h3 class="text-sm sm:text-base font-bold text-gray-900 flex-1 mt-2.5">
                  <a title="">
                    Columbia Ladies Bag
                    <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$14.93</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
            ...
            <div class="relative flex flex-col overflow-hidden bg-white rounded-xl group shadow-lg">
              ...
              <div class="flex flex-col flex-1 px-4 py-5 sm:px-5 sm:py-6">
                ...
                <p class="text-sm sm:text-base text-gray-400 font-bold mt-2.5">$24.19</p>
                <div class="flex items-center mt-2.5 space-x-px">
                  <svg class="w-3 h-3 text-yellow-400 sm:w-4 sm:h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
